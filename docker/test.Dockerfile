...
COPY docker/harness/podh-code docker/harness/podh-publish docker/harness/podh-roots docker/harness/podh-prepare docker/harness/podh-init         /usr/local/bin/podh-init
