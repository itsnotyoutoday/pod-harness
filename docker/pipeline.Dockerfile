...
COPY docker/harness/podh-init docker/harness/podh-preflight \
     ...
     docker/harness/podh-seed-models docker/harness/podh-mount docker/harness/podh-code docker/harness/podh-publish docker/harness/podh-logs docker/harness/podh-roots docker/harness/podh-prepare \
     /usr/local/bin/
