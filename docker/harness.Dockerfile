...
COPY --chmod=0755 docker/harness/podh-init docker/harness/podh-mount docker/harness/podh-code docker/harness/podh-publish docker/harness/podh-roots docker/harness/podh-prepare \
